...
//#define UNITY_OUTPUT_CHAR(a) (void)System_putch(a)
//#define UNITY_OUTPUT_CHAR(a) (void)uartPrintf_putch(a)
#define UNITY_OUTPUT_CHAR(a) (void)kputc(PORT_DEBUG, a)
#else
...
#include <stdio.h>
#define UNITY_OUTPUT_FLUSH (void)System_flush()
#else
  /* If defined as something else, make sure we declare it here so it's ready for use */
...
#ifndef UNITY_PRINT_CR
#define UNITY_PRINT_CR()    UNITY_OUTPUT_CHAR('\r')
#endif
